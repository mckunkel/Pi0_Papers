...
state particles $p;e^+;e^-$ were detected while the photon was 
not detected. This new data sample quadrupled the world bremsstrahlung database 
...
and $\eta$ photoproduction have always been complementary tools to 
...
missing mass squared off the proton, $\mathrm{M_x^2(p) =(P_\gamma + P_p -P^{'}_p)^2}$, where $\mathrm{P's}$ are four-momenta of the incoming photon, target proton and final state proton, and the missing energy of detected system was preformed, see Fig.~\ref{fig:sys}. This 
...
Overall the systematic uncertainty varies between 9\% and 12\% as a function of energy. The individual 
