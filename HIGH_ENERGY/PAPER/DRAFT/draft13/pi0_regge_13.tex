...
0.0182~GeV$^2$ and the Gaussian $\sigma$=0.0043~GeV$^2$. To select \pizT events, a 2.5$\sigma$ cut is placed on the fit function.
%--------------------------------------------------
\begin{figure}[htb!]
\centerline{
...
%%% trying .pdf instead of .eps
        \caption {(Color online) Peak of $\pi^0$ in the missing
                ...
                in final state. The vertical red dashed-dotted line depicts boundary of single \pizT to $\pi^+\pi^-$  production.} \label{fig:pi0_peak}
\end{figure}
%-----------------------------------------------------
%\textbf{Results:} 
