...
photoproduction cross section in Dalitz decay blue and conversion mode on 
...
\gamma\to e^+e^-\gamma$. 
Since the final state contains three charged tracks, $p;e^+;e^-$, running the experiment at high 
current was possible, in contrary to single prong charged track detection, which impose limitations due to trigger and data 
...
fit (shown by red solid line) performed with the CrystalBall function plus 3rd 
...
missing signal state photon but also to constrain the invariant 
