...
\title{Photoproduction of $\pi^0$ on Hydrogen with CLAS \epemT($\gamma$) detection mode}
...
{\color{blue}{constituent}} counting rule while disfavoring the Handbag 
model.
\end{abstract}
%---------------------------------------------
...
{\color{blue}{The rich $\pi + N$ resonance spectrum for center-of-mass 
...
{\color{blue}{The Regge pole description of photoproduction amplitudes 
...
{\color{blue}{The oldest model developed by Goldstein and 
...
{\color{blue}{Subsequently, somewhat similar approaches were developed.  
...
{\color{blue}{The introduction of the handbag mechanism, developed by 
...
This approach was developed to understand the nature of the
observation which the HERMES Collaboration made~\cite{Amarian:2000vx}.
...
{\color{blue}{Binary reactions in QCD, with large momentum transfer 
...
{\color{blue}{Previous bremsstrahlung measurements, for $2~\leq E\leq 
...
{\color{Mycolor2}{The new measurement, presented here, currently is the only 
...
{\color{blue}{In this work, we provide a large set of differential 
...
The experiment was performed {\color{red}{during March-June, 2008}}
...
{\color{red}{The experiment as a whole was a set of different 
...
Lepton identification was based on conservation of {\color{red}{the 
...
mass of $e^+e^-(\gamma)$=m$^2_{\pi^0}$. {\color{red}{The values of 
the ``condence levels" cuts employed was determined using 
statistical signicance to get the best signal/background ratio.
}} The ``confidence levels'' for each constraint were consistent 
between $g12$ data and Monte-Carlo simulations. {\color{red}{
...
{\color{red}{The largest contributions to the systematic uncertainties 
...
\centerline{
	...
	of {\color{red}{(a)}} 50$^\circ$, {\color{red}{(b)}} 70$^\circ$, 
	{\color{red}{(c)}} 90$^\circ$, and {\color{red}{(d)}} 
	...
	{\color{blue}{PR15}} solution (no new CLAS $g12$ data are used 
...
and \ref{fig:t_data} with data from previous {\color{red}{CLAS
...
particularly with the previous {\color{red}{CLAS data.}}
%-----------------------------------------------------
\begin{figure*}[htb!]
\centerline{
	...
	above ``resonance" regime.  {\color{red}{
...
{\color{blue}{constituent}} counting rule~\cite{Brodsky:1973kr}. 
...
s$\sim$10~GeV$^2$ indicate that the {\color{blue}{constituent}} 
...
{\color{red}{This is surprising since there was no previous 
...
photoproduction below $s$ = 11~GeV$^2$ {\color{red}{(blue double 
solid line).}}
%------------------------------------------------------
%\begin{figure}[htb!]
\begin{figure}
...
{\color{red}{The results presented in this paper form part of the 
