void MissingPlots(){
  ...
  mm2plmm2pepem_2->GetYaxis()->SetTitleOffset(0.55);
  ...
  TLine *l3 = new TLine(0.07792,-0.005,0.07792,upEdge);
...
//  //other plot
  ...
  p2 = new TPad("p2", "p2",0,0,1.0,0.54);
  p2->Draw();
  p2->cd();
  ...
  mm2plmE_2->SetLabelSize(0.095, "X");
  mm2plmE_2->SetLabelSize(0.095, "Y");
  
  mm2plmE_2->GetYaxis()->SetTitle("M_{E}(pe^{+}e^{-}) [GeV]");
  mm2plmE_2->GetYaxis()->SetTitleSize(0.093);
  mm2plmE_2->GetYaxis()->SetTitleOffset(0.53);
  
  mm2plmE_2->GetXaxis()->SetTitle("M_{x}^{2}(p) [GeV^{2}]");
  mm2plmE_2->GetXaxis()->SetTitleSize(0.095);
  mm2plmE_2->GetXaxis()->SetTitleOffset(0.8);
  mm2plmE_2->SetTitle("");
  mm2plmE_2->Draw("col");

  
  yBins = mm2plmE_2->GetNbinsY();
  upEdge = mm2plmE_2->GetYaxis()->GetBinUpEdge(yBins);
  lowEdge = mm2plmE_2->GetYaxis()->GetBinLowEdge(0);
  l3 = new TLine(0.07792,-0.0,0.07792,upEdge);
