...
\newcommand*{\BOCHUM}{Institut f\"r Kernphysik, Forschungszentrum 
...
$E = 1.275-5.425$~GeV. In the final state of the reaction, 
photon is missing and $pe^+e^-$ are detected. $\pi^0$ is 
identified in the missing mass of proton and background
is negligible in our case.  These new data are quadrupled 
...
\bibitem{Kunkel} M.~C.~Kunkel, Ph.~D.~Thesis, 2014.
%       https://www.jlab.org/Hall-B/general/thesis/Kunkel_thesis.pdf .
\bibitem{Akbar} Z.~Akbar \textit{et al.}, CLAS Technical Note, 2016.
